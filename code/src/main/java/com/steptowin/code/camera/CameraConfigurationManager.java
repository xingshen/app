...
package com.steptowin.code.camera;
...
final class CameraConfigurationManager {
	...
	void initFromCameraParameters(Camera camera) {
		...
		cameraResolution = getOptimalPreviewSize(
				parameters.getSupportedPreviewSizes(), screenResolution.x,
				screenResolution.y);
	...
	public Point getOptimalPreviewSize(List<Size> sizes, int w, int h) {
