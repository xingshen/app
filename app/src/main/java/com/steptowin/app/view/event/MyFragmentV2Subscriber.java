 ...
 * time:下午2:16
 */
public class MyFragmentV2Subscriber extends BaseFragment {
    ...
    public void onEventMainThread(Event event) {
        switch (event._id){
            case R.id.event_test1:
                String strParams = event.getSecondParamOfArray(String.class);
                tvHint.setText(strParams);
                break;
        }
    }
